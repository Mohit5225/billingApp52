    ...
    <div id="invoice-preview-root" className="fixed inset-0 z-[9999] flex flex-col bg-slate-900/90 backdrop-blur-sm print:static print:bg-white print:backdrop-blur-none">
      ...
      <div className="no-print print:hidden flex shrink-0 items-center justify-between border-b border-white/10 bg-slate-900 px-3 py-3 sm:px-8 sm:py-4">
        <div className="flex items-center gap-2 sm:gap-4">
          <button
            onClick={onClose}
            className="flex items-center gap-1.5 rounded-lg bg-white/10 px-2.5 py-2 text-xs font-semibold text-white transition hover:bg-white/20 active:scale-[0.97] whitespace-nowrap sm:gap-2 sm:px-4 sm:py-2.5 sm:text-sm"
          >
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            onClick={() => window.print()}
            className="flex items-center gap-1.5 rounded-lg bg-tally-600 px-3 py-2 text-xs font-semibold text-white shadow-md transition hover:bg-tally-500 active:scale-[0.97] whitespace-nowrap sm:gap-2 sm:px-6 sm:py-2.5 sm:text-sm"
          >
