    ...
    <>
      ...
      <div className="w-full max-w-lg rounded-2xl bg-white shadow-xl flex flex-col max-h-full">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-bold text-slate-700">Original Invoice No.</label>
                <input
                  type="text"
        ...
        <div className="border-t border-slate-200 bg-slate-50 px-6 py-4 flex justify-end gap-3 rounded-b-2xl">
          ...
          <button
            type="button"
            className="rounded-lg bg-emerald-600 px-5 py-2 text-[15px] font-bold text-white shadow-sm transition hover:bg-emerald-700 hover:shadow"
